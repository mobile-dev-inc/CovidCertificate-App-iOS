 ...
 enum UBLocalized {
   enum Key : String {
    ...
    /// Mit der Covid-19-Impfung können Sie dazu beitragen, die Freiheiten des Alltags zurückzubringen.
     case vaccination_hint_text_9
    /// Jetzt impfen lassen!
     case vaccination_hint_title_1
    /// Jetzt impfen lassen!
  ...
  /// Mit der Covid-19-Impfung können Sie auf das wiederholte Testen verzichten.
   static var vaccination_hint_text_1: String { return UBLocalized.tr(Key.vaccination_hint_text_1) }
  /// Mit der Covid-19-Impfung können Sie unbeschwert in die meisten Länder reisen.
  ...
  /// Mit der Covid-19-Impfung können Sie dazu beitragen, die Freiheiten des Alltags zurückzubringen.
   static var vaccination_hint_text_9: String { return UBLocalized.tr(Key.vaccination_hint_text_9) }
  /// Jetzt impfen lassen!
   static var vaccination_hint_title_1: String { return UBLocalized.tr(Key.vaccination_hint_title_1) }
  /// Jetzt impfen lassen!
  ...
  /// Jetzt impfen lassen!
   static var vaccination_hint_title_9: String { return UBLocalized.tr(Key.vaccination_hint_title_9) }
  /// Impftermin buchen
